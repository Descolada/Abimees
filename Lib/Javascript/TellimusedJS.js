...
<div class="flexRow">
	<div class="flexCol" style="border-right:1px solid #d3d3d3;">
		...
		<div id="Biokeemia-3" class="tellimusnupp">Biokeemia-3</div>
		<div id="Biokeemia-5" class="tellimusnupp">Biokeemia-5</div>
		<div class="separator" style="border-bottom:1px solid #d3d3d3;"></div>
		<div id="Uriin" class="tellimusnupp flexCol">Uriin</div>
	</div>
	<div class="flexCol">
		<div id="Verekülv" class="tellimusnupp">Verekülv</div>
		<div id="Febriilne_neutropeenia" class="tellimusnupp">Febriilne neutropeenia</div>
		<div id="Hüübimine" class="tellimusnupp">Hüübimine</div>
		<div class="separator" style="border-bottom:1px solid #d3d3d3;"></div>
		<div id="Koroona24" class="tellimusnupp">Koroona q24h</div>
		<div id="Koroona48" class="tellimusnupp">Koroona q48h</div>
	</div>
</div>
</div>`;
